...
import { RequestWithBody } from 'src/shared/types/request.type.js';

const requestsOrm = AppDataSource.getRepository(Request);
const resumeOrm = AppDataSource.getRepository(Resumes);

export const RequestService = {
   async getAllRequests(req: RequestExpress, res: Response) {
   ...
   async getRequestsById(req: RequestExpress, res: Response) {
      const { id } = req.params;
   ...
   async deleteRequestById(req: RequestExpress, res: Response) {
      const { id } = req.params;
